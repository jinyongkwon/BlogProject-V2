...
public class MyFilter2 implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
        ...
        if (req.getMethod().equals("POST")) { // 대소문자 구분 잘하기
            ...
            if (contentType.equals("application/x-www-form-urlencoded")) { // username=ssar&password=1234
        ...
        if (loginDto.getPassword().equals("")) { // loginDto.getPassword() == null 일경우는 json에서 loginDto로 파싱해줄때 터짐.
